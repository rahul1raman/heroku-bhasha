...
const sentences = [
    "The man who passes the sentence should swing it",
...
class Bhasha extends React.Component {
    render(){
        return(
...
const renderBhashaApp = () => {
    ReactDOM.render(<Bhasha />, document.getElementById('app'));
};
