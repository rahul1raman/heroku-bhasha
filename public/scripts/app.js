...
var Bhasha = function (_React$Component9) {
    _inherits(Bhasha, _React$Component9);

    function Bhasha() {
        _classCallCheck(this, Bhasha);

        return _possibleConstructorReturn(this, (Bhasha.__proto__ || Object.getPrototypeOf(Bhasha)).apply(this, arguments));
    }
...
var renderBhashaApp = function renderBhashaApp() {
    ReactDOM.render(React.createElement(Bhasha, null), document.getElementById('app'));
};
